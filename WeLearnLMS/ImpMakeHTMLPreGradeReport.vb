Public Class ImpMakeHTMLPreGradeReport
    ...
    Public Function MakeHTML(ByRef Datatable As DataTable) As String Implements IMakeHTML.MakeHTML
        ...
        With builder
            ...
            .Append("<p style=""font-family:arial"">" & "Pre Grade Reports for Class: " & _SharedClassroom.ClassroomName & EndP)
            .Append("<p class=""PartialReports"">" & "(Partial Reports)" & EndP)
